...
`;e.i(843476);var u=e.i(890118);let T=t.default.div.withConfig({displayName:"ApiMetaData__ApiMetaDataWrapper",componentId:"sc-7fc4547e-0"})``;t.default.div.withConfig({displayName:"ApiMetaData__Row",componentId:"sc-7fc4547e-1"})`
...
`;e.s(["TableOfContents",0,function(){let e=(0,i.useAppSelector)(a.selectKeyNavigating);return(0,t.jsx)(m,{"aria-label":"table of contents",children:(0,t.jsx)(u,{$isKeyNavigating:e,children:(0,t.jsx)(O,{})})})}],145360)},707095,e=>{"use strict";var t=e.i(843476),o=e.i(997053),i=e.i(109950),a=e.i(646107),n=e.i(515681),r=e.i(506390),l=e.i(801770),s=e.i(728191),d=e.i(475086),c=e.i(112426),S=e.i(202623),p=e.i(145360);let A="28rem",E="21rem",g=l.SPACINGS.SEVEN,f=o.css`
  min-width: 0;
  flex: 0 0 auto;
...
`,_=(0,o.default)(n.PageFrame).withConfig({displayName:"PageGrid__PageGridWrapper",componentId:"sc-4288d600-0"})`
  position: relative;
  display: flex;
  flex-wrap: wrap;
...
`,h=o.default.div.withConfig({displayName:"PageGrid__TableOfContentsWrapper",componentId:"sc-4288d600-3"})`
  ${f};
  ...
  ${({$isStartPage:e})=>e&&o.css`
      display: none;
    `};
`;e.s(["PageGrid",0,function(e){let{children:o,layout:n}=e,r=(0,i.useAppSelector)(a.selectRoutesLoading),l=n===s.PAGE_LAYOUTS.HOME,A=l?"MD":void 0,E=(0,d.useSidebarNavigationContext)(),g=(0,S.arrayHasItems)(E.flatRoutes);return(0,t.jsxs)(_,{size:A,children:[g&&(0,t.jsx)($,{$isStartPage:l,children:(0,t.jsx)(c.SidebarNavigation,{})}),(0,t.jsx)(I,{role:"main","aria-live":"polite",$isStartPage:l,"aria-busy":r,children:o}),(0,t.jsx)(h,{$isStartPage:l,children:(0,t.jsx)(p.TableOfContents,{})})]})}])},922275,e=>{"use strict";var t=e.i(843476),o=e.i(271645),i=e.i(997053),a=e.i(615632),n=e.i(955596),r=e.i(989023),l=e.i(350437),s=e.i(925866),d=e.i(801770),c=e.i(202623),S=e.i(907827),p=e.i(850056),A=e.i(109950),E=e.i(728191),g=e.i(506390),f=e.i(890118),_=e.i(654938);let I=i.default.nav.withConfig({displayName:"PageBreadcrumbs__PageBreadcrumbsWrapper",componentId:"sc-6318225-0"})`
...
`;e.s(["PageBreadcrumbs",0,function(){let e=(0,n.useRouteBreadcrumbs)(),i=(0,A.useAppSelector)(p.selectKeyNavigating);return(0,c.arrayHasItems)(e)?(0,t.jsx)(I,{"aria-label":"Breadcrumb Navigation",$isKeyNavigating:i,children:(0,t.jsx)($,{children:e.map(({slug:i,title:a},n)=>n!==e.length-1?(0,t.jsxs)(o.Fragment,{children:[(0,t.jsx)(O,{href:i,children:a}),(0,t.jsx)(m,{size:"0.8rem",svg:"chevronRight",role:"presentation","aria-hidden":"false"})]},i):(0,t.jsx)(C,{children:a},i))})}):null}])}]);